...
public final class WTexScanSettingsManager extends DoomToolsSettings
{
	 ...
	 */
	public static WTexScanSettingsManager get()
	{
		return INSTANCE.get();
	}
	...
	private WTexScanSettingsManager()
	{
		super(getConfigFile(SETTINGS_FILENAME), DoomToolsLogger.getLogger(WTexScanSettingsManager.class));
	}

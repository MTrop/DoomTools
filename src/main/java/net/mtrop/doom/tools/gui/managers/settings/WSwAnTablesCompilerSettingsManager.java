...
public final class WSwAnTablesCompilerSettingsManager extends DoomToolsSettings
{
	 ...
	 */
	public static WSwAnTablesCompilerSettingsManager get()
	{
		return INSTANCE.get();
	}
	...
	private WSwAnTablesCompilerSettingsManager()
	{
		super(getConfigFile(SETTINGS_FILENAME), DoomToolsLogger.getLogger(WSwAnTablesCompilerSettingsManager.class));
	}

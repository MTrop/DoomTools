...
public enum DEHThingDoom19Flag implements DEHFlag
{
	...
	UNUSED1       (0x08000000, "Thing palette translation bit 0. If set, palette range 112-127 (green) is now 64-79 (brown). If set with TRANSLATION, it is 32-47 (red)."),
	TRANSLATION2  (0x08000000, "Thing palette translation bit 0. If set, palette range 112-127 (green) is now 64-79 (brown). If set with TRANSLATION, it is 32-47 (red)."),
